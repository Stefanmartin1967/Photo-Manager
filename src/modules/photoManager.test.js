...
describe('PhotoManager - renameGroup', () => {
    ...
    test('should rename an existing group correctly', async () => {
    ...
    test('should revert to default name when renamed to null or empty', async () => {
        // Setup: Create a photo and add it to create a group
    ...
    test('should do nothing when renaming a non-existent group', async () => {
        // Setup: Create a photo and add it to create a group
